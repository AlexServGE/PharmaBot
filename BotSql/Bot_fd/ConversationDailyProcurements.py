...
class ConversationDailyProcurements:
    ...
    def start(self, update, context):
        ...
        update.message.reply_text(
            ...
            'Выбери категорию лекарственных препаратов, по которой хотел бы получить информацию об актуальных закупках (будут показаны публикации, вышедшие за вчера и сегодня):',
