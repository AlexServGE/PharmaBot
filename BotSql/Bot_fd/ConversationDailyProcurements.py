...
class ConversationDailyProcurements:
    ...
    def start(self, update, context):
        ...
        update.message.reply_text(
            ...
            'Я здесь, чтобы помочь Вам быть в курсе закупок лекарственных препаратов 44-ФЗ.  '
            'Команда /cancel, чтобы прекратить разговор.\n\n'
            'Выбери категорию лекарственных препаратов, по которой хотел бы получить информацию об актуальных закупках:',
